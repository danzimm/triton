...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="The proton command utility for profiling scripts and pytest tests.",
        usage="""
...
""",
    ...
    parser.add_argument(
        "-c", "--context", type=str, help="Profiling context", default="shadow", choices=["shadow", "python"]
    )
    ...
    parser.add_argument(
        ...
        "--instrument",
        type=str,
        help="Instrumentation analysis type",
        default=None,
